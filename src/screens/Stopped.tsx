      ...
      >
        <div>
          <div style={{ position: "absolute", top: "23%", left: "10%" }}>
            <div
              className={clsx(
                currentPlayer === "player1" ? "-bg-player1" : "-bg-player2"
              )}
              style={{
                position: "absolute",
                left: "calc(-0% - 10vw)",
          ...
          <div style={{ position: "absolute", top: "23%", right: "10%" }}>
            ...
            />
            <Button variant="rotated" color="disabled" borderOnly disabled />
          </div>
        </div>
        <div
          style={{
        ...
        >
          <Button
            ...
            color="gradient"
            borderOnly
            onClick={() => {}} //TODO: redirect to landingScreen
          >
