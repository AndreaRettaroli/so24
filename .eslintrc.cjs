module.exports = {
  ...
  extends: ['standard', 'eslint:recommended', 'plugin:@typescript-eslint/recommended', 'plugin:react-hooks/recommended', 'plugin:json/recommended', 'plugin:storybook/recommended'],
  ...
  rules: {
    ...
    "padding-line-between-statements": [
        2,
        { "blankLine": "always", "prev": ["const", "let", "var", "if", "export", "class", "function"], "next": "*" },
        { "blankLine": "always", "prev": "*", "next": ["if", "return", "export", "class", "function"] },
